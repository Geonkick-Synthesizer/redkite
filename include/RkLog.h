...
#define RK_LOG_DEBUG(msg) std::cout << "[DEBUG] " << RK_PRETTY_FUNCTION << ": " << msg << std::endl
...
#define RK_LOG_INFO(msg) std::cout << "[INFO] " << RK_PRETTY_FUNCTION << ": " << msg << std::endl
...
#define RK_LOG_WARN(msg) std::cout << "[WARN] " << RK_PRETTY_FUNCTION << ": " << msg << std::endl
...
#define RK_LOG_ERROR(msg) std::cout << "[ERROR] " << RK_PRETTY_FUNCTION << ": " << msg << std::endl
#else
